...
__decorate([
    ...
    Transform(({ value }) => { if (/^[0-9]+$/.test(value) || value == undefined)
        ...
        throw { status: 400, message: `El dato estcita_id incumple los parametros acordados` }; }, { toClassOnly: true }),
...
__decorate([
    ...
    Transform(({ value }) => { if (/^[a-z A-Z áéíóúÁÉÍÓÚñÑüÜ]+$/.test(value))
        ...
        throw { status: 400, message: `El dato estcita_nombre incumple los parametros acordados` }; }, { toClassOnly: true }),
